...
class UsersController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $users = $em->getRepository('Gdr3625BackofficeBundle:Users')->findAll();
    ...
    {
        $user = new Users();
        $form = $this->createForm('Gdr3625\BackofficeBundle\Form\UsersType', $user);
    ...
    {
        $deleteForm = $this->createDeleteForm($user);
        $editForm = $this->createForm('Gdr3625\BackofficeBundle\Form\UsersType', $user);
